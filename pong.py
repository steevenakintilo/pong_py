...
def menu_loop():
    ...
    GAME_FONT2 = pygame.freetype.Font("font.ttf", 74)
...
def end_loop(MOD):
    ...
    while running:
        ...
        if MOD == 3:
            GAME_FONT.render_to(screen, (200, 30), "IA YOU WON", (255, 255, 255))
        if MOD == 4:
            GAME_FONT.render_to(screen, (200, 30), "IA BLUE YOU WON", (255, 255, 255))
        if MOD == 5:
